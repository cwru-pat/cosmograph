...
# Normalize conformal metric and trace-free extrinsic curvature?
if(DEFINED COSMO_EXCLUDE_SECOND_ORDER_E)
  add_definitions(-DEXCLUDE_SECOND_ORDER_E=${COSMO_EXCLUDE_SECOND_ORDER_E})
  message(STATUS "${Cyan}Setting EXCLUDE_SECOND_ORDER_E=${COSMO_EXCLUDE_SECOND_ORDER_E}.${ColorReset}")
endif()
...
unset(COSMO_EXCLUDE_SECOND_ORDER_E CACHE)
