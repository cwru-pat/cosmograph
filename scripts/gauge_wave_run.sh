...
# Gauge wave in x-direction
cmake -DCOSMO_N=50 -DCOSMO_NY=6 -DCOSMO_NZ=6 -DCOSMO_H_LEN_FRAC=1 .. && make -j16
sed -i -E "s/gauge_wave_dir = [0-9]+/gauge_wave_dir = 1/g" ../config/AwA/gauge_wave_test_r1.txt
...
cmake -DCOSMO_N=50 -DCOSMO_NX=6 -DCOSMO_NZ=6 -DCOSMO_H_LEN_FRAC=1 .. && make -j16
sed -i -E "s/gauge_wave_dir = [0-9]+/gauge_wave_dir = 2/g" ../config/AwA/gauge_wave_test_r1.txt
./cosmo ../config/AwA/gauge_wave_test_r1.txt

# Gauge wave in z-direction (lowest res only)
cmake -DCOSMO_N=50 -DCOSMO_NX=6 -DCOSMO_NY=6 -DCOSMO_H_LEN_FRAC=1 .. && make -j16
sed -i -E "s/gauge_wave_dir = [0-9]+/gauge_wave_dir = 3/g" ../config/AwA/gauge_wave_test_r1.txt
./cosmo ../config/AwA/gauge_wave_test_r1.txt
