...
cmake -DCOSMO_N=200 -DCOSMO_NY=4 -DCOSMO_NZ=4 -DCOSMO_H_LEN_FRAC=1 .. && make -j16
...
cmake -DCOSMO_N=200 -DCOSMO_NY=4 -DCOSMO_NZ=4 -DCOSMO_USE_Z4c_DAMPING=1 -DCOSMO_H_LEN_FRAC=1 .. && make -j16
./cosmo $TMP_CONFIG_FILE

# Lower resolutions
cmake -DCOSMO_N=50 -DCOSMO_NY=4 -DCOSMO_NZ=4 -DCOSMO_H_LEN_FRAC=1 .. && make -j16
./cosmo ../config/AwA/stability_test_r1.txt
cmake -DCOSMO_N=100 -DCOSMO_NY=4 -DCOSMO_NZ=4 -DCOSMO_H_LEN_FRAC=1 .. && make -j16
