...
inline real_t conformal_average(arr_t *field,
  arr_t *DIFFphi, real_t phi_FRW)
{
...
inline real_t conformal_standard_deviation(arr_t *field,
  arr_t *DIFFphi, real_t phi_FRW, real_t avg)
{
